...
//
//     final muridModel = muridModelFromJson(jsonString);

import 'package:meta/meta.dart';
import 'dart:convert';

MuridModel muridModelFromJson(String str) => MuridModel.fromJson(json.decode(str));

String muridModelToJson(MuridModel data) => json.encode(data.toJson());
...
class MuridModel {
  ...
  factory MuridModel.fromJson(Map<String, dynamic> json) => MuridModel(
    id: json["id"],
    name: json["name"],
    email: json["email"],
