...
class TeacherModel {
  ...
  factory TeacherModel.fromJson(Map<String, dynamic> json) => TeacherModel(
        ...
        alamatGuru: List<AlamatGuru>.from(
            json["alamat_guru"].map((x) => AlamatGuru.fromJson(x))),
...
class User {
  ...
  factory User.fromJson(Map<String, dynamic> json) => User(
        ...
        secretAt: json["secret_at"] != null
            ? DateTime.parse(json["secret_at"])
            : null,
